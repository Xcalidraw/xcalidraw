...
import polyfill from "./packages/xcalidraw/polyfill";
import { yellow } from "./packages/xcalidraw/tests/helpers/colorize";
import { testPolyfills } from "./packages/xcalidraw/tests/helpers/polyfills";
...
vi.mock(
  "./packages/xcalidraw/fonts/XcalidrawFontFace",
