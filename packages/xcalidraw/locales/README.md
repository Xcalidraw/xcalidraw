...
- to request a new translation, [open an issue](https://github.com/xcalidraw/xcalidraw/issues/new/choose).
- to update existing translations, [edit them on Crowdin](https://crowdin.com/translate/xcalidraw/10) and we should have them included in the app soon!
