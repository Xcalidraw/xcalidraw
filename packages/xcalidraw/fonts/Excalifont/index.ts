...
copyright: Copyright (c) 2024 by Xcalidraw. All rights reserved.
...
trademark: Excalifont is a trademark of Xcalidraw.
...
export const ExcalifontFontFaces: XcalidrawFontFaceDescriptor[] = [
  {
    uri: _0,
    descriptors: {
      unicodeRange:
