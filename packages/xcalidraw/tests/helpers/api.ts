...
import { pointFrom, type LocalPoint, type Radians } from "@xcalidraw/math";

import { DEFAULT_VERTICAL_ALIGN, ROUNDNESS, assertNever } from "@xcalidraw/common";
...
import { isLinearElementType } from "@xcalidraw/element";
...
export class API {
  ...
  >({
    ...
    switch (type) {
      ...
      case "triangle":
        element = newElement({
          type: type as "rectangle" | "diamond" | "ellipse" | "triangle",
          ...base,
        });
        break;
      case "embeddable":
