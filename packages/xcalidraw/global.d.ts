interface Window {
  ClipboardItem: any;
  __XCALIDRAW_SHA__: string | undefined;
  XCALIDRAW_ASSET_PATH: string | string[] | undefined;
  XCALIDRAW_THROTTLE_RENDER: boolean | undefined;
  DEBUG_FRACTIONAL_INDICES: boolean | undefined;
  XCALIDRAW_EXPORT_SOURCE: string;
  gtag: Function;
  sa_event: Function;
