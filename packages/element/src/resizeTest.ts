...
import type { AppState, Zoom } from "@xcalidraw/xcalidraw/types";

import type { GlobalPoint, LineSegment, LocalPoint } from "@xcalidraw/math";
...
export const getElementWithTransformHandleType = (
  ...
  }, null as { element: NonDeletedXcalidrawElement; transformHandleType: MaybeTransformHandleType } | null);
};
