...
const recomputeOrigin = (
  stateAtCropStart: NonDeleted<XcalidrawElement>,
  transformHandle: TransformHandleType,
  width: number,
  height: number,
...
// refer to https://link.xcalidraw.com/l/6rfy1007QOo/6stx5PmRn0k
export const getUncroppedImageElement = (
  ...
  if (element.crop) {
    ...
    const uncroppedElement: XcalidrawImageElement = {
      ...element,
...
export const getUncroppedWidthAndHeight = (element: XcalidrawImageElement) => {
  if (element.crop) {
    const width =
