...
import type { FontString, XcalidrawTextElement } from "./types";
 ...
 */
export const detectLineHeight = (textElement: XcalidrawTextElement) => {
  const lineCount = splitIntoLines(textElement.text).length;
  return (textElement.height /
    lineCount /
    textElement.fontSize) as XcalidrawTextElement["lineHeight"];
};
