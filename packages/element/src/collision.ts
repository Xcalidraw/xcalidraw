import { isTransparent } from "@xcalidraw/common";
import {
...
import type { FrameNameBounds } from "@xcalidraw/xcalidraw/types";

import type { Curve, GlobalPoint, LineSegment, Radians } from "@xcalidraw/math";
