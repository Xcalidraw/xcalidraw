import { getLineHeight } from "@xcalidraw/common";
import { API } from "@xcalidraw/xcalidraw/tests/helpers/api";

import { FONT_FAMILY, TEXT_ALIGN, VERTICAL_ALIGN } from "@xcalidraw/common";
...
import type { XcalidrawTextElementWithContainer } from "../src/types";
