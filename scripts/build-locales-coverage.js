...
const files = readdirSync(`${__dirname}/../packages/xcalidraw/locales`);
...
for (let index = 0; index < locales.length; index++) {
  ...
  const data = flatten(
    require(`${__dirname}/../packages/xcalidraw/locales/${currentLocale}`),
  );
...
writeFileSync(
  `${__dirname}/../packages/xcalidraw/locales/percentages.json`,
