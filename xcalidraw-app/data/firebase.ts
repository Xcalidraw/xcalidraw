...
import { encryptData, decryptData } from "@xcalidraw/xcalidraw/data/encryption";
import { restoreElements } from "@xcalidraw/xcalidraw/data/restore";
import { getSceneVersion } from "@xcalidraw/element";
...
const decryptElements = async (
  ...
  roomKey: string,
): Promise<readonly XcalidrawElement[]> => {
...
export const saveToFirebase = async (
  ...
  const storedScene = await runTransaction(firestore, async (transaction) => {
    ...
    const reconciledElements = getSyncableElements(
      reconcileElements(
        elements,
        prevStoredElements as OrderedXcalidrawElement[] as RemoteXcalidrawElement[],
        appState,
      ),
    );
