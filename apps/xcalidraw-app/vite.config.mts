  ...
  return {
    ...
    resolve: {
      alias: [
        ...
        {
          find: /^@xcalidraw\/xcalidraw$/,
          replacement: path.resolve(
            __dirname,
            "../../packages/xcalidraw/index.tsx",
          ),
        },
        {
          find: /^@xcalidraw\/xcalidraw\/(.*?)/,
          replacement: path.resolve(__dirname, "../../packages/xcalidraw/$1"),
        },
        {
          find: /^@xcalidraw\/math$/,
    ...
    build: {
      ...
      rollupOptions: {
        output: {
          ...
          manualChunks(id) {
            if (
              id.includes("packages/xcalidraw/locales") &&
