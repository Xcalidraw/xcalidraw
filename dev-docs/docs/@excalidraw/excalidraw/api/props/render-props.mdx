...
For example you can use this prop to render the size of the elements in the storage as do in [xcalidraw.com](https://xcalidraw.com).
...
<pre>
  (element: NonDeleted&lt;XcalidrawEmbeddableElement&gt;, appState:{" "}
  <a href="https://github.com/xcalidraw/xcalidraw/blob/master/packages/xcalidraw/types.ts#L95">
    AppState
  </a>
  ) => JSX.Element | null
...
| --- | --- | --- |
| `element` | `NonDeleted<XcalidrawEmbeddableElement>` | The embeddable element to be rendered. |
