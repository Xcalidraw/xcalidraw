...
By default Xcalidraw will render the `MainMenu` with default options. If you want to customise the `MainMenu`, you can pass the `MainMenu` component with the list options.
    ...
    <div style={{ height: "500px" }}>
      <Xcalidraw>
        <MainMenu>
          ...
          <MainMenu.ItemLink href="https://xcalidraw.com">
            Xcalidraw
          </MainMenu.ItemLink>
        </MainMenu>
      </Xcalidraw>
...
For the items which are shown in the menu in [xcalidraw.com](https://xcalidraw.com), you can use `MainMenu.DefaultItems`
...
Here is a [complete list](https://github.com/xcalidraw/xcalidraw/blob/master/packages/xcalidraw/components/main-menu/DefaultItems.tsx) of the default items.
...
function App() {
  return (
    <div style={{ height: "500px" }}>
      <Xcalidraw>
        <MainMenu>
          <MainMenu.Group title="Xcalidraw items">
            <MainMenu.DefaultItems.Socials />
            <MainMenu.DefaultItems.Export />
          </MainMenu.Group>
